...
We employ **MAPPO** with the **CTDE paradigm**—decentralized actors for scalable execution and a centralized critic for effective credit assignment. Training is accelerated through **curriculum learning**, progressively increasing obstacle density from 0 to 8 trees across 5 stages.
...
# Train agents
make train
# or: docker run --rm -v "${PWD}/search_rescue_logs:/app/search_rescue_logs" student-search:latest train.active=true
...
**Default Configuration (6 rescuers, 12 victims, 9 landmarks):**
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Adorján Nagy-Mohos** | TorchRL migration, Curriculum learning, CTDE/MAPPO architecture, Hydra + Docker integration, Victim dynamics, Scenario generation           |
...
| **Sándor Baranyi**     | Vision system (occlusion logic), Continuous control implementation, Ablation studies, Energy budget features                                |
...
- Yu, C., et al. (2022). _The Surprising Effectiveness of PPO in Cooperative Multi-Agent Games._ NeurIPS.
- Lowe, R., et al. (2017). _Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments._ NeurIPS.
